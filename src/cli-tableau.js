// from https://github.com/keymetrics/cli-tableau but right align was not working so faster to copy for now
...
import {repeat, truncate, options, strlen} from './utils.js'
...
Table.prototype.toString = function () {
  ...
  function getWidth (obj) {
    return typeof obj === 'object' && obj && obj.width !== undefined
         ? obj.width
         : ((typeof obj === 'object' && obj !== null ? strlen(obj.text) : strlen(obj)) + (style['padding-left'] || 0) + (style['padding-right'] || 0))
  }
  ...
  function string (str, index) {
    ...
    return repeat(' ', style['padding-left'] || 0) +
         (length === width ? str
             : (length < width ?
                str/*.padEnd((width + (str.length - length)), ' ', align === 'left' ? 'right' : (align === 'middle' ? 'both' : 'left'))*/.
                  padStart(width + (str.length - length))
              :
